...
from world.ultralytics.hub.utils import HELP_MSG, HUB_WEB_ROOT, PREFIX, TQDM
...
class HUBTrainingSession:
    """
    HUB training session for Ultralytics HUB YOLO_xyz models. Handles model initialization, heartbeats, and checkpointing.

    Attributes:
        model_id (str): Identifier for the YOLO_xyz model being trained.
