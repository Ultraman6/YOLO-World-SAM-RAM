...
def update_models(model_names=("yolov8n.pt",), source_dir=Path(""), update_names=False):
    """
    Updates and re-saves specified YOLO_xyz models in an 'updated_models' subdirectory.
    ...
    Examples:
        Update specified YOLO_xyz models and save them in 'updated_models' subdirectory:
