ABSOLUTE_PATH = 'F:/Github/YOLO-World/'
_backend_args = None
...
coco_val_dataset = dict(
    _delete_=True,
    class_text_path='F:/Github/YOLO-World/data/texts/lvis_v1_class_texts.json',
    dataset=dict(
        ann_file='lvis/lvis_v1_minival_inserted_image_name.json',
        batch_shapes_cfg=None,
        data_prefix=dict(img=''),
        data_root='F:/Github/YOLO-World/data/coco/',
        test_mode=True,
...
flickr_train_dataset = dict(
    ...
    data_root='F:/Github/YOLO-World/data/flickr/',
...
load_from = 'F:/Github/YOLO-World/weights/yolo_world_v2_x_obj365v1_goldg_cc3mlite_pretrain_1280ft-14996a36.pth'
log_level = 'INFO'
...
mg_train_dataset = dict(
    ...
    data_root='F:/Github/YOLO-World/data/mixed_grounding/',
...
obj365v1_train_dataset = dict(
    ...
    dataset=dict(
        ...
        data_root='F:/Github/YOLO-World/data/objects365v1/',
        filter_cfg=dict(filter_empty_gt=False, min_size=32),
...
test_dataloader = dict(
    ...
    dataset=dict(
        class_text_path=
        'F:/Github/YOLO-World/data/texts/lvis_v1_class_texts.json',
        dataset=dict(
            ann_file='lvis/lvis_v1_minival_inserted_image_name.json',
            batch_shapes_cfg=None,
            data_prefix=dict(img=''),
...
test_evaluator = dict(
    ann_file=
    'F:/Github/YOLO-World/data/coco/lvis/lvis_v1_minival_inserted_image_name.json',
    metric='bbox',
    proposal_nums=(
        100,
        1,
