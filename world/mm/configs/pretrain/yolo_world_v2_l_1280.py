...
load_from = "pretrained_models/yolo_world_v2_l_640.pth"
...
obj365v1_train_dataset = dict(
    ...
    dataset=dict(
        ...
        data_root=ABSOLUTE_PATH + 'data/objects365v1/',
        ann_file='annotations/objects365_train.json',
        data_prefix=dict(img='train/'),
        filter_cfg=dict(filter_empty_gt=False, min_size=32)),
    class_text_path=ABSOLUTE_PATH + 'data/texts/obj365v1_class_texts.json',
    pipeline=train_pipeline)

mg_train_dataset = dict(type='YOLOv5MixedGroundingDataset',
                        data_root=ABSOLUTE_PATH + 'data/mixed_grounding/',
...
flickr_train_dataset = dict(
    ...
    data_root=ABSOLUTE_PATH + 'data/flickr/',
...
coco_val_dataset = dict(
    ...
    dataset=dict(type='YOLOv5LVISV1Dataset',
                 data_root=ABSOLUTE_PATH + 'data/coco/',
                 test_mode=True,
                 ann_file='lvis/lvis_v1_minival_inserted_image_name.json',
                 data_prefix=dict(img=''),
                 batch_shapes_cfg=None),
    class_text_path=ABSOLUTE_PATH + 'data/texts/lvis_v1_class_texts.json',
    pipeline=test_pipeline)
val_dataloader = dict(dataset=coco_val_dataset)
test_dataloader = val_dataloader

val_evaluator = dict(type='mmdet.LVISMetric',
                     ann_file=ABSOLUTE_PATH + 'data/coco/lvis/lvis_v1_minival_inserted_image_name.json',
                     metric='bbox')
