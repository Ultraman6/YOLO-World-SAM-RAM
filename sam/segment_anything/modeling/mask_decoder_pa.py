...
class MaskDecoderPA(MaskDecoder):
    def __init__(self, model_type):
        ...
        checkpoint_dict = {"vit_b": "weights/sam/segment_anything_pa/sam_vit_b_maskdecoder.pth",
                           "vit_l": "weights/sam/segment_anything_pa/sam_vit_l_maskdecoder.pth",
                           'vit_h': "weights/sam/segment_anything_pa/sam_vit_h_maskdecoder.pth"}
